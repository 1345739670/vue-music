<template>
  <div class="player" v-show="playList.length > 0">
    ...
    <audio :src="currentMusicUrl" ref="audio" @play="ready" @error="error" @timeupdate="updateTime" @ended="end"></audio>
  </div>
</template>
...
export default {
  ...
  methods: {
    ...
    middleTouchMove (e) {
      ...
      const offWidth = Math.min(Math.max(-window.innerWidth, left + deltaX))
      this.touch.percent = Math.abs(offWidth / window.innerWidth)
